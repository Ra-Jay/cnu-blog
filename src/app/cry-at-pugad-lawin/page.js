				...
				<div className="w-full flex flex-col gap-3">
					<div className="flex gap-4 mb-36">
						<span className="first-letter:text-5xl first-letter:font-bold first-letter:mr-3 first-letter:float-left">
							The <span className="text-sky-600 font-bold italic mr-2">"Cry of Pugad Lawin" </span> heralded the official start of the Philippine
							Revolution against Spain. The insurrection rose in vigor and expanded to eight provinces, including Manila, Bulacan, Cavite, Pampanga,
							Tarlac, Laguna, Batangas, and Nueva Ecija, which were subsequently represented by the eight sun rays of the current Filipino flag.
							heralded the official start of the Philippine Revolution against Spain. The insurrection rose in vigor and expanded to eight provinces,
							including Manila, Bulacan, Cavite, Pampanga, Tarlac, Laguna, Batangas, and Nueva Ecija, which were subsequently represented by the eight
							sun rays of the current Filipino flag.
						</span>
						<Image
							src={PugadLawin}
							alt={'Pugad Lawin'}
					...
					<span className="mb-6">
						...
						City, by tearing off their <span className="text-sky-600 font-bold">"cedulas"</span>, which became a symbol of Filipino captivity. This
						episode, known as the <span className="text-sky-600 font-bold">"Cry of Pugad Lawin"</span>, is officially acknowledged as the beginning of
						the Philippine Revolution against Spain by the use of violence and weaponry.
					</span>

					<h3 className="text-2xl font-bold mt-6">DEFINITION OF THE CRY</h3>
					<span className="mb-2">
						The term <span className="text-sky-600 font-bold">"cry"</span> is derived from the Spanish el grito de rebelion (rebellion cry), or el
						grito for short. Thus, the Grito de Balintawak is identical to Mexico's Grito de Dolores (1810). However,{' '}
						<span className="text-sky-600 font-bold italic">"el grito de rebelion"</span> refers to a choice or call to revolt. Unlike the Filipino
						terms <span className="text-sky-600 font-bold">Sigaw</span> or <span className="text-sky-600 font-bold">Sigao</span>, it does not always
						imply yelling.
					</span>
					<span className="mb-2">
					...
					<span className="mb-2">
						The cry can also be seen in the inscriptions <span className="text-sky-600 font-bold italic">"Viva la Independencia Filipina,"</span>{' '}
						which was actually followed by patriotic shouts.
					</span>
					...
					<div className="rounded-xl border-l-2 border-gray-100 px-14 py-6  mt-3">
						<ul className="list-disc flex flex-col gap-4">
							...
							<li>
								Some of the seeming misunderstanding regarding the location stems from the dual meanings of the words "Balintawak" and "Caloocan" at
							...
							<li>Andrés Bonifacio's close colleague, Po Valenzuela, declared in 1948 that the event occurred on August 23, 1896, in Pugad Lawin.</li>
						</ul>
					</div>

					<h3 className="text-2xl font-bold mt-10">EVENTS PRIOR TO THE CRY OF PUGAD LAWIN</h3>
					<span className="mb-2">
						Several events occurred to deepen the Filipino people's solidarity and to create a{' '}
					...
					<span className="mb-2">
						...
						<span className="text-sky-600 font-bold">("Supreme and Venerable Association of the Children of the Nation")</span> are among these.
					</span>
					...
					<div className="rounded-xl border-l-2 border-gray-100 px-14 py-6 mt-3">
						<ul className="list-disc flex flex-col gap-4">
							...
							<li>
								On August 19, 1896, the equipment used in printing Katipunan documents and other materials was discovered, indicating the Katipunan's
								existence.
							</li>
					...
					<span className="mb-2">
						...
						<span className="text-sky-600 font-bold italic">"Long live the Philippines,"</span> which became known as the Cry of Pugad Lawin in
						Philippine history.
					</span>
					<span className="mb-2">
